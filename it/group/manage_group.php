...
?>
<diiv class="card card-outline card-info">
...
<div class="card-body">
    <form action="" id="group-form">
        ...
        <div class="form-group">
            ...
            <textarea name="group_name" id=""  cols="30" rows="2" class="form-control form no-resize"><?php echo isset($group_name)? $group_name : ''; ?></textarea>
        </div>
        <div class="form-group">
