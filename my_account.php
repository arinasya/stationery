                ...
                <div class="w-100 justify-content-between d-flex">
                    ...
                    <table class="table table-stripped text-dark">
                        ...
                        <tbody>
                            <?php 
                                $i = 1;
                                $qry = $conn->query("SELECT o.*,username as user from `orders` o inner join users u on u.id = o.user_id where o.user_id = '".$_settings->userdata('id')."' order by unix_timestamp(o.order_date) desc ");
