        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT o.*,department as users from `orders` o inner join users u on u.id = o.user_id order by unix_timestamp(o.order_date) desc ");
								 ...
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu"> 
									...
									<?php if($row['confirm'] == 0 && $row['status'] != 4): ?>
										<a class="dropdown-item confirm" href="javasript:void(0)" data-id="<?php echo $row['id'] ?>">Confirm</a>
									<?php endif; ?>
