                ...
                <tbody>
                    ...
                    $i = 1;
                        ...
                        while($row = $qry->fetch_assoc()):
                            $olist = $conn->query("SELECT ol.*,i.name, department,o.date_created FROM order_list ol inner join orders o on o.id = ol.order_id inner join `items` i on i.id = ol.item_id inner join users  u on u.id = o.user_id  where ol.order_id = '{$row['order_id']}' ");
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="m-0"><?php echo $roww['department'] ?></p>
                        </td>
